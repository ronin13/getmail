...
class SimpleIMAPRetriever(IMAPRetrieverBase, IMAPinitMixIn):
    ...
    _confitems = (
        ...
        ConfBool(name='use_xoauth', required=False, default=False),
        ConfString(name='oauth_token',required=False,default=None),
        ConfString(name='oauth_token_secret',required=False,default=None),
        ConfString(name='oauth_user',required=False,default=None),
    )
    received_from = None
    received_with = 'IMAP4'
    received_by = localhostname()
